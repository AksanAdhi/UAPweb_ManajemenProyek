...
<link rel="stylesheet" href="tabel-jadwal.css" media="screen">
    ...
    <meta property="og:title" content="tabel-jadwal">
  ...
  <body data-path-to-root="./" data-include-products="false" class="u-body u-xl-mode" data-lang="en">
          ...
          <div class="u-layout-row">
            <div class="u-container-style u-layout-cell u-size-14 u-layout-cell-1">
              <div class="u-container-layout u-container-layout-1">
                ...
                <a href="tabel-tugas.php" class="u-border-none u-btn u-button-style u-hover-grey-5 u-none u-text-grey-60 u-text-hover-black u-btn-7"><span class="u-file-icon u-icon u-text-palette-1-dark-1"><img src="images/36.png" alt=""></span> &nbsp;&nbsp;Tugas
                </a>
                <a href="tabel-jadwal.php" class="u-border-0 u-btn u-button-style u-grey-5 u-hover-grey-5 u-text-black u-text-hover-black u-btn-8"><span class="u-file-icon u-icon u-text-palette-1-dark-1 u-icon-8"><img src="images/37.png" alt=""></span> &nbsp;&nbsp;Jadwal
                </a>
              ...
              <div class="u-container-layout u-valign-middle u-container-layout-2">
                <div class="custom-expanded u-container-style u-custom-color-2 u-group u-radius u-shape-round u-group-1">
                  <div class="u-container-layout u-container-layout-3">
                    ...
                    <h3 class="u-text u-text-black u-text-5">Jadwal</h3>
                    ...
                    <a href="#carousel_cc9b" class="u-border-0 u-btn u-button-style u-dialog-link u-palette-1-base u-btn-10"><span class="u-file-icon u-icon u-text-white u-icon-12"><img src="images/2997933-1e106104.png" alt=""></span>&nbsp;Tambah​ Jadwal
                    </a>
                      ...
                      <table class="u-table-entity">
                          ...
                          <thead class="u-align-center u-table-header u-table-header-1">
                              <tr style="height: 45px;">
                                  ...
                                  <th class="u-border-1 u-border-grey-dark-1 u-table-cell">Proyek</th>
                                  <th class="u-border-1 u-border-grey-dark-1 u-table-cell">Tugas</th>
                                  <th class="u-border-1 u-border-grey-dark-1 u-table-cell">Status Tugas</th>
                              </tr>
                          </thead>
                          <tbody class="u-align-center u-table-body u-table-body-1">
                              ...
                              $sql = "SELECT j.idJadwal, p.nama, t.namaTugas, j.statusTugas
                                      FROM daftar_jadwal j
                                      INNER JOIN daftar_proyek p ON j.idProyek = p.id
                                      INNER JOIN daftar_tugas t ON j.idTugas = t.idTugas";
                              ...
                              if ($result->num_rows > 0) {
                                  ...
                                  while($row = $result->fetch_assoc()) {
                                      ...
                                      echo "<td class='u-border-1 u-border-grey-30 u-table-cell'>" . $row["idJadwal"] . "</td>";
                                      echo "<td class='u-border-1 u-border-grey-30 u-table-cell'>" . $row["nama"] . "</td>";
                                      echo "<td class='u-border-1 u-border-grey-30 u-table-cell'>" . $row["namaTugas"] . "</td>";
                                      echo "<td class='u-border-1 u-border-grey-30 u-table-cell'>" . $row["statusTugas"] . "</td>";
                                      echo "</tr>";
                                  }
                              } else {
                                  echo "<tr style='height: 46px;'><td colspan='4' class='u-border-1 u-border-grey-30 u-table-cell'>Tidak ada data</td></tr>";
                              }
                              ?>
                          </tbody>
                      </table>
                    ...
                    <a href="#carousel_8c5a" class="u-border-0 u-btn u-button-style u-dialog-link u-palette-1-base u-btn-11"><span class="u-file-icon u-icon u-text-white u-icon-13"><img src="images/1828911-c7f81fa6.png" alt=""></span>&nbsp;Edit​ Jadwal
                    </a>
                    <a href="#carousel_79f6" class="u-border-0 u-btn u-button-style u-dialog-link u-palette-1-base u-btn-12"><span class="u-file-icon u-icon u-text-white u-icon-14"><img src="images/3405244-93167e14.png" alt=""></span>&nbsp;Hapus Jadwal
                    </a>
                  </div>
                </div>
              </div>
    ...
    <section class="u-black u-clearfix u-container-style u-dialog-block u-opacity u-opacity-70 u-valign-middle u-dialog-section-9" id="carousel_cc9b">
      <div class="u-align-center u-container-style u-dialog u-gradient u-radius u-shape-round u-dialog-1">
        <div class="u-container-layout u-container-layout-1">
          <h4 class="u-align-center u-text u-text-default u-text-1">Tambah Jadwal</h4>
          <div class="custom-expanded u-border-2 u-border-palette-5-base u-custom-color-2 u-form u-radius u-form-1">
            <form action="tambah_jadwal.php" class="u-clearfix u-form-spacing-12 u-form-vertical u-inner-form" source="email" name="form" style="padding: 20px;">
              <div class="u-form-group u-form-select u-label-top u-form-group-2">
                <label for="select-6410" class="u-custom-font u-heading-font u-label u-label-2">Proyek</label>
                <div class="u-form-select-wrapper">
                  <select id="select-6410" name="idProyek" class="u-input u-input-rectangle u-radius u-input-2" required="required">
                  <?php
                 include 'koneksi.php';
                  // Query untuk mengambil data proyek
                  $sql_proyek = "SELECT id, nama FROM daftar_proyek";
                  $result_proyek = $conn->query($sql_proyek);

                  // Membuat dropdown berdasarkan hasil query
              ...
              <div class="u-form-group u-form-select u-label-top u-form-group-3">
                <label for="select-758e" class="u-custom-font u-heading-font u-label u-label-3">Tugas</label>
                <div class="u-form-select-wrapper">
                <select id="select-758e" name="idTugas" class="u-input u-input-rectangle u-radius u-input-3" required="required">
                <?php
                 include 'koneksi.php';
              ...
              <div class="u-form-group u-form-select u-label-top u-form-group-4">
                <label for="select-882b" class="u-custom-font u-heading-font u-label u-label-4">Status Tugas</label>
                <div class="u-form-select-wrapper">
                  <select id="select-882b" name="statusTugas" class="u-input u-input-rectangle u-radius u-input-4" required="required">
                    <option value="SEDANG_DIPROSES" data-calc="SEDANG_DIPROSES">SEDANG_DIPROSES</option>
                    <option value="BELUM_DIMULAI" data-calc="BELUM_DIMULAI">BELUM_DIMULAI</option>
                    <option value="SELESAI" data-calc="SELESAI">SELESAI</option>
                    <option data-calc="TERTUNDA" value="TERTUNDA">TERTUNDA</option>
                  </select>
                  <svg class="u-caret u-caret-svg" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="16px" height="16px" viewBox="0 0 16 16" style="fill:currentColor;" xml:space="preserve"><polygon class="st0" points="8,12 2,4 14,4 "></polygon></svg>
                </div>
              </div>
              <div class="u-align-center u-form-group u-form-submit u-label-top">
                ...
                <a href="tabel-jadwal.php" onclick="location.reload();" class="u-border-0 u-btn u-btn-submit u-button-style u-white u-btn-1">Kirim</a>
              </div>
...
.u-dialog-section-9 .u-label-3 {
  font-weight: 700;
}

.u-dialog-section-9 .u-input-3 {
  --radius: 7px;
}
...
.u-dialog-section-9 .u-label-4 {
  font-weight: 700;
}

.u-dialog-section-9 .u-input-4 {
  --radius: 7px;
}
...
<section class="u-black u-clearfix u-container-style u-dialog-block u-opacity u-opacity-70 u-valign-middle u-dialog-section-10" id="carousel_8c5a">
      <div class="u-align-center u-container-style u-dialog u-gradient u-radius u-shape-round u-dialog-1">
        <div class="u-container-layout u-container-layout-1">
          <h4 class="u-align-center u-text u-text-default u-text-1">Edit Jadwal</h4>
          <div class="custom-expanded u-border-2 u-border-palette-5-base u-custom-color-2 u-form u-radius u-form-1">
            <form action="edit_jadwal.php" class="u-clearfix u-form-spacing-12 u-form-vertical u-inner-form" source="email" name="form" style="padding: 20px;">
              <div class="u-form-group u-form-name u-form-partition-factor-2 u-label-top">
                ...
                <select id="idTugas" name="idTugas" class="u-input u-input-rectangle u-radius u-input-3" required>
                                ...
                                $sql_jadwal = "SELECT idJadwal, statusTugas FROM daftar_jadwal";
                                $result_jadwal = $conn->query($sql_jadwal);

                                if ($result_jadwal->num_rows > 0) {
                                    while ($row_jadwal = $result_jadwal->fetch_assoc()) {
                                        $selected = ($row_jadwal['idJadwal'] == $row['idJadwal']) ? 'selected' : '';
                                        echo "<option value='" . $row_jadwal['idJadwal'] . "' $selected>" . $row_jadwal['statusTugas'] . "</option>";
                                    }
                                } else {
              ...
              <div class="u-form-group u-form-partition-factor-2 u-form-select u-label-top u-form-group-2">
                <label for="select-6410" class="u-custom-font u-heading-font u-label u-label-2">Proyek</label>
                <div class="u-form-select-wrapper">
                <select id="idProyek" name="idProyek" class="u-input u-input-rectangle u-radius u-input-2" required>
                                <?php
                                include 'koneksi.php';
                                // Fetch project options from database
                                $sql_proyek = "SELECT idProyek, namaProyek FROM proyek";
                                $result_proyek = $conn->query($sql_proyek);

                                if ($result_proyek->num_rows > 0) {
                                    while ($row_proyek = $result_proyek->fetch_assoc()) {
                                        $selected = ($row_proyek['idProyek'] == $row['idProyek']) ? 'selected' : '';
                                        echo "<option value='" . $row_proyek['idProyek'] . "' $selected>" . $row_proyek['namaProyek'] . "</option>";
                                    }
                                } else {
              ...
              <div class="u-form-group u-form-select u-label-top u-form-group-3">
                ...
                <select id="idTugas" name="idTugas" class="u-input u-input-rectangle u-radius u-input-3" required>
                                <?php
                                include 'koneksi.php';
                                // Fetch task options from database
                                $sql_tugas = "SELECT idTugas, namaTugas FROM tugas";
                                $result_tugas = $conn->query($sql_tugas);
              ...
              <div class="u-form-group u-form-select u-label-top u-form-group-4">
                <label for="select-882b" class="u-custom-font u-heading-font u-label u-label-4">Status Tugas</label>
                <div class="u-form-select-wrapper">
                <select id="statusTugas" name="statusTugas" class="u-input u-input-rectangle u-radius u-input-4" required>
                                <option value="SEDANG_DIPROSES" <?php if ($row['statusTugas'] == 'SEDANG_DIPROSES') echo 'selected'; ?>>SEDANG_DIPROSES</option>
                                <option value="BELUM_DIMULAI" <?php if ($row['statusTugas'] == 'BELUM_DIMULAI') echo 'selected'; ?>>BELUM_DIMULAI</option>
                                <option value="SELESAI" <?php if ($row['statusTugas'] == 'SELESAI') echo 'selected'; ?>>SELESAI</option>
                                <option value="TERTUNDA" <?php if ($row['statusTugas'] == 'TERTUNDA') echo 'selected'; ?>>TERTUNDA</option>
                            </select>
                  <svg class="u-caret u-caret-svg" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="16px" height="16px" viewBox="0 0 16 16" style="fill:currentColor;" xml:space="preserve"><polygon class="st0" points="8,12 2,4 14,4 "></polygon></svg>
                </div>
              </div>
...
<section class="u-black u-clearfix u-container-style u-dialog-block u-opacity u-opacity-70 u-valign-middle u-dialog-section-16" id="carousel_79f6">
      <div class="u-align-center u-container-style u-dialog u-gradient u-radius u-shape-round u-dialog-1">
        <div class="u-container-layout u-valign-middle u-container-layout-1">
          <h4 class="u-align-center u-text u-text-default u-text-1">Hapus Jadwal</h4>
          <div class="custom-expanded u-border-2 u-border-palette-5-base u-custom-color-2 u-form u-radius u-form-1">
            <form action="hapus_jadwal.php" class="u-clearfix u-form-spacing-12 u-form-vertical u-inner-form" source="email" name="form" style="padding: 20px;">
              <div class="u-form-group u-form-select u-label-top u-form-group-1">
                ...
                <div class="u-form-select-wrapper">
                <select id="select-000e" name="idJadwal" class="u-input u-input-rectangle u-radius u-input-1" required="required">
                <option value="">Pilih ID Jadwal</option>
                <?php
          
                include 'koneksi.php';
                
                $sql = "SELECT idJadwal, statusTugas FROM daftar_jadwal";
                $result = $conn->query($sql);

                if ($result->num_rows > 0) {
                  while ($row = $result->fetch_assoc()) {
                    echo "<option value='" . $row['idJadwal'] . "'>" . $row['idJadwal'] . " - " . $row['statusTugas'] . "</option>";
                  }
                }
