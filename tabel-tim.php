...
<html style="font-size: 16px;" lang="en"><head>
    ...
    <title>tabel-tim</title>
    <link rel="stylesheet" href="nicepage.css" media="screen">
<link rel="stylesheet" href="tabel-tim.css" media="screen">
    ...
    <meta property="og:title" content="tabel-tim">
          ...
          <div class="u-layout-row">
            <div class="u-container-style u-layout-cell u-size-14 u-layout-cell-1">
              <div class="u-container-layout u-container-layout-1">
                ...
                <a href="tabel-tim.php" class="u-border-0 u-btn u-button-style u-grey-5 u-hover-grey-5 u-text-black u-text-hover-black u-btn-5"><span class="u-file-icon u-icon u-text-palette-1-dark-1 u-icon-5"><img src="images/34.png" alt=""></span>&nbsp;&nbsp;Tim
                </a>
              ...
              <div class="u-container-layout u-valign-middle u-container-layout-2">
                <div class="custom-expanded u-container-style u-custom-color-2 u-group u-radius u-shape-round u-group-1">
                  <div class="u-container-layout u-container-layout-3">
                    ...
                    <h3 class="u-text u-text-black u-text-5">Tim</h3>
                    ...
                    <a href="#carousel_96fd" class="u-border-0 u-btn u-button-style u-dialog-link u-palette-1-base u-btn-10"><span class="u-file-icon u-icon u-text-white u-icon-12"><img src="images/2997933-1e106104.png" alt=""></span>&nbsp;Tambah​ Tim
                    </a>
...
// Query untuk mengambil data dari tabel daftar_tim
$query = "SELECT idTim, namaTim, idProyek FROM daftar_tim";
...
<div class="custom-expanded u-table u-table-responsive u-table-1">
  <table class="u-table-entity">
    ...
    <tbody class="u-align-center u-table-body u-table-body-1">
      <?php
      $query = "SELECT dt.idTim, dt.namaTim, dp.nama AS namaProyek
      FROM daftar_tim dt
      INNER JOIN daftar_proyek dp ON dt.idProyek = dp.id";
...
$result = $conn->query($query);
      ...
      if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
          ...
          echo "<td class='u-border-1 u-border-grey-30 u-table-cell'>" . $row['idTim'] . "</td>";
          echo "<td class='u-border-1 u-border-grey-30 u-table-cell'>" . $row['namaTim'] . "</td>";
          echo "<td class='u-border-1 u-border-grey-30 u-table-cell'>" . $row['namaProyek'] . "</td>";
          echo "</tr>";
        }
      } else {
      ...
      ?>
                    ...
                    <a href="#carousel_bcbd" class="u-border-0 u-btn u-button-style u-dialog-link u-palette-1-base u-btn-11"><span class="u-file-icon u-icon u-text-white u-icon-13"><img src="images/1828911-c7f81fa6.png" alt=""></span>&nbsp;Edit​ Tim
                    </a>
                    <a href="#carousel_ae9e" class="u-border-0 u-btn u-button-style u-dialog-link u-palette-1-base u-btn-12"><span class="u-file-icon u-icon u-text-white u-icon-14"><img src="images/3405244-93167e14.png" alt=""></span>&nbsp;Hapus Tim
                    </a>
                  </div>
                </div>
              </div>
    ...
    <!-- tambah tim -->
    <section class="u-black u-clearfix u-container-style u-dialog-block u-opacity u-opacity-70 u-valign-middle u-dialog-section-6" id="carousel_96fd">
  <div class="u-align-center u-container-style u-dialog u-gradient u-radius u-shape-round u-dialog-1">
    <div class="u-container-layout u-container-layout-1">
      <h4 class="u-align-center u-text u-text-default u-text-1">Tambah Tim</h4>
      <div class="custom-expanded u-border-2 u-border-palette-5-base u-custom-color-2 u-form u-radius u-form-1">
        <form action="tambah_tim.php" method="POST" class="u-clearfix u-form-spacing-12 u-form-vertical u-inner-form" source="email" name="form" style="padding: 20px;">
          <div class="u-form-group u-label-top">
            <label for="email-04ca" class="u-custom-font u-heading-font u-label u-label-2">Nama</label>
            <input type="text" placeholder="Masukkan nama tim" id="email-04ca" name="namaTim" class="u-input u-input-rectangle u-radius u-input-2" required="required">
          </div>
          <div class="u-form-group u-form-select u-label-top u-form-group-3">
            <label for="idProyek" class="u-custom-font u-heading-font u-label u-label-3">Proyek</label>
            <div class="u-form-select-wrapper">
            <select id="select-882b" name="idProyek" class="u-input u-input-rectangle u-radius u-input-3" required="required">
    <?php
    // Query untuk mengambil data proyek dari tabel daftar_proyek
...
<!-- edit_tim -->
<section class="u-black u-clearfix u-container-style u-dialog-block u-opacity u-opacity-70 u-valign-middle u-dialog-section-12" id="carousel_bcbd">
      <div class="u-align-center u-container-style u-dialog u-gradient u-radius u-shape-round u-dialog-1">
        <div class="u-container-layout u-container-layout-1">
        ...
        <div class="u-form-select-wrapper">
            ...
            <svg class="u-caret u-caret-svg" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="16px" height="16px" viewBox="0 0 16 16" style="fill:currentColor;" xml:space="preserve"><polygon class="st0" points="8,12 2,4 14,4 "></polygon></svg>
              ...
              <div class="u-form-group u-label-top">
                <label for="email-04ca" class="u-custom-font u-heading-font u-label u-label-2">Nama</label>
                <input type="text" placeholder="Masukkan nama tim" id="email-04ca" name="namaTim" class="u-input u-input-rectangle u-radius u-input-2">
              </div>
              <div class="u-form-group u-form-select u-label-top u-form-group-3">
...
.u-dialog-section-12 .u-label-1 {
  font-weight: 700;
}

.u-dialog-section-12 .u-input-1 {
  --radius: 7px;
}

.u-dialog-section-12 .u-label-2 {
  font-weight: 700;
}

.u-dialog-section-12 .u-input-2 {
  --radius: 7px;
}
...
.u-dialog-section-12 .u-label-3 {
  font-weight: 700;
}

.u-dialog-section-12 .u-input-3 {
  --radius: 7px;
}
...
<!-- hapus_tim -->
<section class="u-black u-clearfix u-container-style u-dialog-block u-opacity u-opacity-70 u-valign-middle u-dialog-section-18" id="carousel_ae9e">
      <div class="u-align-center u-container-style u-dialog u-gradient u-radius u-shape-round u-dialog-1">
        <div class="u-container-layout u-valign-middle u-container-layout-1">
          <h4 class="u-align-center u-text u-text-default u-text-1">Hapus Tim</h4>
          <div class="custom-expanded u-border-2 u-border-palette-5-base u-custom-color-2 u-form u-radius u-form-1">
            <form action="hapus_tim.php" class="u-clearfix u-form-spacing-12 u-form-vertical u-inner-form" source="email" name="form" style="padding: 20px;">
              <div class="u-form-group u-form-select u-label-top u-form-group-1">
                ...
                <div class="u-form-select-wrapper">
                <select id="select-000e" name="idTim" class="u-input u-input-rectangle u-radius u-input-1" required="required">
                <option value="">Pilih ID Tim</option>
                <?php
          
                include 'koneksi.php';
                // Query to fetch ID Tim options
                $sql = "SELECT idTim, namaTim FROM daftar_tim";
                $result = $conn->query($sql);
    ...
    <style>.u-dialog-section-18 .u-dialog-1 {
  width: 678px;
  min-height: 377px;
  height: auto;
  --radius: 15px;
...
.u-dialog-section-18 .u-form-group-1 {
  margin-left: 0;
}
